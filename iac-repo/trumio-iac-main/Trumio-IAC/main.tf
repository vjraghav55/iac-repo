...
module "aks" {
  ...
  aks_sysnp_name             = "${var.org}sysnp${var.ins_count}"
  ...
  aks_sysnp_vm_size          = var.aks_sysnp_vm_size[1]
  aks_sysnp_os_disk_size_gb  = var.aks_sysnp_os_disk_size_gb[0]
  ...
  aks_usrnp_vm_sizes         = var.aks_usrnp_vm_sizes
  aks_usrnp_os_disk_size_gb  = var.aks_usrnp_os_disk_size_gb[0]
...
module "app_gateway" {
  ...
  key_vault_secret_id        = module.keyvault.keyvault_secret_id
