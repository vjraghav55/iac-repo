...
variable "subnets" {
    ...
    default = {
      subnet1 = {
        name = "aks-snet"
        address_prefix = ["10.31.0.0/22"]
    }
     subnet2 = {
        name = "appgw-snet"
        address_prefix = ["10.31.6.0/27"]
    }
     subnet3 = {
        name = "ts-snet"
        address_prefix = ["10.31.7.0/26"]
    }
     subnet4 = {
        name = "pvtep-snet"
        address_prefix = ["10.31.6.64/27"]
    }
     subnet5 = {
        name = "GatewaySubnet"
        address_prefix = ["10.31.7.224/27"]
    }
     subnet6 = {
        name = "flexi-subnet"
        address_prefix = ["10.31.4.0/27"]
    }
  }
}
...
variable "storage_config" {
  ...
  default = {
    storage_account1 = {
      ...
      cors_rule = [{
        allowed_origins     = ["https://prod-app.trumio.ai"]
...
variable "aks_sysnp_vm_size" {
  ...
  type = list(string)
  default = [ "Standard_F4s_v2", "Standard_F2s_v2" ]   
}
...
variable "aks_usrnp_vm_sizes" {
  ...
  type = list(string)
  default = [ "Standard_D2as_v5", "Standard_F4s_v2" ]   
}
...
variable "request_routing_rule" {
  ...
  default = {
    ...
    "routing_rule2" = {
      ...
      priority                    = "2"
      rule_type                   = "Basic"
      http_listener_name          = "listerner2"
      backend_address_pool_name   = "backend2"
      backend_http_settings_name  = "setting2"
    }
    "routing_rule3" = {
      name                        = "rule3"
      priority                    = "3"
      rule_type                   = "Basic"
      http_listener_name          = "listerner3"
      backend_address_pool_name   = "backend3"
      backend_http_settings_name  = "setting3"
    }
  }
}
